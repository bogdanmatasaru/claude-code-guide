...
See [cost-optimization.md](../guides/cost-optimization.md) for why a lean memory file saves money. Starter templates live in [`assets/claude-md/`](../../assets/claude-md/).
