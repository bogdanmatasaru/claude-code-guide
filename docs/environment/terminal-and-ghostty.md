...
The bootstrap script [`../../setup.sh`](../../setup.sh) installs Ghostty (plus JetBrains Mono) and writes the config below for you. To do it by hand, read on.

## The recommended config

Config lives at `~/.config/ghostty/config`. This is the exact block [`../../setup.sh`](../../setup.sh) writes:
